...
Feature: Authorization
  ...
  Background:
    Given the following users exist:
      ...
      | admin@example.com     | password2 | ROLE_ADMIN     |
      | committee@example.com | password3 | ROLE_COMMITTEE |
  ...
  Scenario Outline: Authenticated users can only access certain endpoints
    ...
    Examples:
      ...
      | test@example.com      | password1 | /testOnly/adminOnly     | 404              |
      | test@example.com      | password1 | /testOnly/committeeOnly | 404              |
      | admin@example.com     | password2 | /testOnly/adminOnly     | 200              |
      | admin@example.com     | password2 | /testOnly/committeeOnly | 404              |
      | committee@example.com | password3 | /testOnly/adminOnly     | 404              |
